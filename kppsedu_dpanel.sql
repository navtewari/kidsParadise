...
--
-- Host: localhost:3306
-- Generation Time: Dec 14, 2018 at 09:56 AM
...
(1, 'Sports & Games', 'kpps', '2018-09-17 15:47:12', 1),
(2, 'Cultural', 'kpps', '2018-09-17 15:46:08', 1),
(3, 'Others', 'kpps', '2018-09-17 16:05:40', 1);
...
(1, 'DSCN3522.JPG', 'x', 0, 0, 2, 1, 'kpps'),
(2, 'DSCN3459.JPG', 'x', 0, 0, 1, 1, 'kpps');
...
(2, 'SARASWATI PUJA', 'For many Hindus, Vasant Panchami is the festival dedicated to goddess Saraswati who is their ancient goddess of knowledge, language, music and all arts. She is the energy of Brahma, and she symbolizes creative energy and power in all its form, including longing and love (kama). The season and festival also reflects the agricultural fields which are ripening with yellow flowers of mustard crop, which Hindus associate with Saraswati\'s favorite color. People dress in yellow saris or shirts or acces', 1, '2018-12-10 11:30:16', '');
...
(1, 'Admission Fair Spring', '2018-09-24', 'Kids Paradise School welcomes you.', 'x', '2018-09-13 18:29:36', 1, 'kpps'),
(2, 'Gandhi Jayanti', '2018-10-02', 'Kids Paradise School celebrates Gandhi Jayanti.', 'x', '2018-09-13 18:32:44', 1, 'kpps');
...
('gopal', '123', 'adm', 'The dpanel of School', 'school'),
('kpps', 'kpps$#123', 'ofc', 'Kids Paradise Public School', 'School'),
...
(1, 'Admission Fair Spring', 'Kids Paradise School.', 'x', 'Arial', '13/09/2018', '2018-09-15', '2018-10-06', '11:34:29pm', 1, 'kpps'),
(2, 'Admission Fair Spring', 'Kids Paradise School.', 'x', 'Arial', '15/09/2018', '2018-09-15', '2018-10-06', '11:35:04pm', 1, 'kpps'),
(3, 'Our badminton star', 'Our school Badminton player Ansh arora is selected for International Badminton competition which is held in China. ', '3.jpg', 'Arial', '12/12/2018', '2018-12-12', '2019-02-01', '03:45:27pm', 1, 'kpps'),
(4, 'Kids Paradise Environment', 'The students are taught to be disciplined,self- sufficeint, self confident, helpfull and to be habitat of mercy.', 'x', 'Arial', '13/12/2018', '2018-12-13', '2019-09-30', '01:25:38pm', 1, 'nitin');
...
ALTER TABLE `activities`
  ...
  ADD KEY `ACTIVECATEGID` (`ACTIVITYCATEGID`);
...
--
ALTER TABLE `activities_category`
  MODIFY `ACT_CATEG_ID` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `downloads`
  MODIFY `DWNLD_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `importantdates`
  MODIFY `IMPDTID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
