        ...
        <div class="row">
            <div class="col-lg-6 video">
                ...
                <div style="margin-top:2em;">
                    <button class="btn btn-primary up1"><i class="fa fa-arrow-circle-up" aria-hidden="true"></i></button>
                    <button class="btn btn-primary down1"><i class="fa fa-arrow-circle-down" aria-hidden="true"></i></button>
                </div>
            </div>
